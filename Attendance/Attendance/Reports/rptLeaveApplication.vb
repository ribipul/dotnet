...
Public Class rptLeaveApplication
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Attendance.rptLeaveApplication.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptLeaveApplication
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptLeaveApplication = New rptLeaveApplication()
        rpt.Site = Me.Site
        Return rpt
    End Function
