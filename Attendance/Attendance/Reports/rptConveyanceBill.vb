...
Public Class rptConveyanceBill
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Attendance.rptConveyanceBill.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptConveyanceBill
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptConveyanceBill = New rptConveyanceBill()
        rpt.Site = Me.Site
        Return rpt
    End Function
