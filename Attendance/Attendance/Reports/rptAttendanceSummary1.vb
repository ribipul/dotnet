...
Public Class rptAttendanceSummary
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Attendance.rptAttendanceSummary.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptAttendanceSummary
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptAttendanceSummary = New rptAttendanceSummary()
        rpt.Site = Me.Site
        Return rpt
    End Function
