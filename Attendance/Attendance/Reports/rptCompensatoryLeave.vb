...
Public Class rptCompensatoryLeave
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Attendance.rptCompensatoryLeave.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCompensatoryLeave
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCompensatoryLeave = New rptCompensatoryLeave()
        rpt.Site = Me.Site
        Return rpt
    End Function
